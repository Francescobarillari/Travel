...
interface ActivityRepository {
    ...
    suspend fun searchActivities(query: String, minStartTime: String? = null, maxEndTime: String? = null, page: Int = 0, size: Int = 10): Result<it.unical.ea.dtos.common.PageDto<ActivityTemplateDto>> = throw NotImplementedError()
    ...
    suspend fun getBookedUsers(id: String): Result<List<it.unical.ea.dtos.user.UserPublicDTO>> = throw NotImplementedError()
