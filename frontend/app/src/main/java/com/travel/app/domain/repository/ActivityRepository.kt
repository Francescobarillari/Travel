...
interface ActivityRepository {
    ...
    suspend fun searchActivities(query: String, minPrice: Double? = null, maxPrice: Double? = null, minStartTime: String? = null, page: Int = 0, size: Int = 10): Result<it.unical.ea.dtos.common.PageDto<ActivityDto>> = throw NotImplementedError()
